...
\dcLabelS{\https{gdoc.com} $\land$ \https{eff.org}}{}) to a new iframe (5) which
...
responses.\footnote{On authentication: note that when the browser
  ...
  \https{chase.com}, it still includes any cookies cached for
  \https{chase.com} in the request.}
%
