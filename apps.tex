...
\caption{\label{fig:mashup} Third-party mashup under \sys{}.\todo{}{It should be
  chase.com instead of bank.ch}}
\end{figure}
...
\Red{XXX bk: moved here from design; needs to be pared down
and integrated.}
...
\https{unq0}, and spawn a DOM worker (1), delegating both privileges to it.  The
main context drops both privileges (2), while both compartments raise
their label to \dcLabelS{\https{a.com} $\land$ \https{unq0}}{} (3).  Finally, the
