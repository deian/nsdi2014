...
it opens an iframe to \https{nsa.gov}, exercising its privilege to keep
its initial label as \https{nsa.gov} so it can (2) talk to the \https{nsa.gov}
...
its label to ``\https{gdoc.com} and \https{nsa.gov}'' to read the decryption.
