...
The SOP specifies that resources (e.g., images, scripts, documents,
...
\https{fb.com}) in which we omit the port, if it is standard, i.e., 80
or 443.
...
bidirectionally by setting a common \js{document.domain}, modifying
the \js{window.name} property, using fragment-id
messaging~\cite{fragmentmessaging}, or using the \js{postMessage}
