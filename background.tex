...
by content from the same origin~\cite{rfc6454,googlehandbook}\tocite{VanKesteren2012}.
%
...
attacks attacks~\tocite{barthspaper}, a second argument
...
Addressing cross-site scripting (XSS) attacks~\tocite{xss}\Red{Ale: there is not
  an standard XSS reference}, CSP~\tocite{Sterne2012} provides developers with a
means for white-listing the origins from which their application is allowed to
load resources.
%
