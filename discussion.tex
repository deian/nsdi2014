...
content per security label (as in~\tocite{DeGroef:2012}) is not
...
% language-based approaches~\tocite{} provide a more fine-grain labeling of
% data. JSFlow, for example, allows to label individual variables and
% DOM-elements; FlowFox

%  , \sys{} can be considered as coarse-grain information-flow system. For
% instance,



%% JSFlow, FlowFox ... low level objects, but you need to re-estructure your
%% program. 
%% Implicit labeling
%% Communication among iframes is asynchronous, and may chance the semantics. 
