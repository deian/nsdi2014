...
\todo{ds}{Note on lass pass an other benefiting from \sys}
...
\todo{all}{can we just remove this paragraph?}


At first glance, it may appear that executing labeled workers
...
threads to five\todo{ds}{check latest}, as to avoid denial of service
...
%
\todo{ds}{maybe not on service workers}
%
