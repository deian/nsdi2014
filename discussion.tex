...
%
While users may white-list malicious origins, which, as we discuss
below, can leak information through covert channels, this is still an
improvement over the status quo where users would otherwise have given
