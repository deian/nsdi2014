...
and server white-listing is provided; \todo{ale}{Not clear to me, do you mean 
``In particular, COWL will use the server-supplied label and 
server white-listing when available;''}
...
%
At first this may appear as a completely new risk \todo{}{for data exfiltration}.
%
