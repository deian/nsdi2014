...
Worker comm.       &  0.20    &   0.24  &  0.03$\dagger$   &  0.07  &  0.07  & 0.03$\dagger$  % 90 messages ping-pong
%%\\\midrule%--------------------------------------------------------------------
...
\paragraph{Iframes and lightweight workers} The average (of 10 runs creating 10) performance impact of creating an
...
%
In the labeled case we report the cost of creating light-weight labeled
...
%
We highlight that communicating with light-weight workers is also
...
the order of 1 microsecond; in most cases, it is recomputing of
...
at 54ms).
%
\todo{ezyang}{The alternate really needs to be put in}
