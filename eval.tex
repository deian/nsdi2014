...
attributed to noise.
%
We also measured the performance of using a \verb|"labeled-blob"|
response type with just \verb|"blob"| to be \Red{XX\% slower}; this
however, is on par with setting a CORS header for the vanilla case
(\Red{XXX\% slower/faster}).
%
