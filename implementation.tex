...
about ``border crossing'' between compartments. 
...
%
Thus, all inter-browsing context access control
checks---as specified by the SOP---are enforced by the wrappers.
%
...
%
Table~\ref{tab:comm}, we rely on compartment wrappers to
