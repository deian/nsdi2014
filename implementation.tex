...
ensure that all subsequent cross-compartment access is, in addition to
the SOP, also mediated by confinement.
%
...
access.
%
This ensures that the performance penalty of wrappers between pages of
the same origin does not exist.
%
...
Figure~\ref{fig:api:compartments}, reuses these labeled
...
and Firefox extension~\cite{Carlini:2012, addon-sdk}; in fact, our
...
\js|default-src 'none'|) as to disallow all network communication;
