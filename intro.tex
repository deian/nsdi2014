...
\Red{Not clear how jQuery is an example of network-accessible content
  and services.  Is that point that most people use the version hosted
  by Google?  If so must state explicitly.}
