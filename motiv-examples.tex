...
these untrusted libraries. This unpalatable trade-off between privacy
and convenience for the programmer in today's web programming status
quo raises again the importance of robust confinement for the
browser---of allowing untrusted code to compute over sensitive data,
but confining the code so as to prevent leakage of the sensitive
data. Once more, MAC-based confinement intuitively seems to fit
well.
