...
scripts provided by (potentially distrusted) third parties. To make
...
\emph{labeled} (Section~\ref{sec:system:contexts}) with the origins to whose
...
write). We illustrate the raising of a label with bubbles connoting
the sensitivity of data being integrated.
And a compartment's \emph{privilege,} which specifies the
