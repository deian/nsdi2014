...
inspect the DOM and cookies of another context if they share the same
 origin, \emph{i.e.,} \https{a.com}. Similarly, such code can only inspect
...
compartment---\emph{i.e.,} that disallows communication that would ordinarily
...
lifetime (\emph{e.g.,} a page may not drop the privilege to communicate with
...
enclosing context or some other context, \emph{e.g.,} when determining
