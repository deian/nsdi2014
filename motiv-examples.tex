...
the checker script's iframe using XHR\@; the browser \emph{labels} the
...
communicate, each must each be able to confine the other's further use
of data it has sent to the other.
