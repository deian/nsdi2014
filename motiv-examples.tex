...
privacy \todo{}{What does it mean strong? Is there a weak privacy notion? why
  not just privacy?} for the user in today's web browsers. These examples
...
inspect the DOM and cookies of another context if they share the same
 origin, i.e., \https{a.com}. Similarly, such code can only inspect
...
\js|public|. 
\todo{}{Here, it would be clearer to refer explicitly to the message, e.g., 
