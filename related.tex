...
In general, the per-object granularity of fine-grained IFC makes
...
While fine-grained IFC systems may be more convenient for
developers, these systems impose new language semantics for
developers to learn and require more invasive and slower
implementations.
%
In contrast, \sys{} repurposes familiar isolation constructs
and can be given a fast implementation by eschewing JavaScript engine modifications.
%
...
compartments. Similarly, the typically short lifetime of a browsing context
helps avoid excessive accumulation of taint.
%
