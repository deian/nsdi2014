...
\todo{ds}{have lots of notes, mostly want to rewrite}
...
% BFlow
\Red{
  - encrypted docs: trusted zone and lack of symmetry on what child
  can impose on parent frame (want frames)
  - password manager: labels cannot contain tags from different
  websites: can't do partial declassification
  - third party mashup
  + third-parthy libraries/services
  + labels to server (we do too)
}
