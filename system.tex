...
%
Finally, such labeled communication enables another useful design
pattern: contexts can use labeled Blobs to send ``high-integrity''
data via a untrusted intermediary contexts.
%%XXX(ds): is this too much detail that is not clear?
