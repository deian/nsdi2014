...
%
\footnote{
  Our system also handles \emph{integrity}, but we largely omit it
...
only compartments with the privilege for the origin can write to
...
\begin{itemize}
    ...
    \item A privilege usually must be exercised to edit the DOM
