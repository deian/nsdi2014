...
another context, a context also becomes more restricted in where it
can write.
%
...
their parent.
%
(The initial label of a top-level context, i.e., a page, is public
unless the web server attaches a \js|COWL-label| header to the page
specifying a more restricting label.)
%
