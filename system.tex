...
propagated to a less sensitive entity, such as \https{amazon.com};
...
%
\todo{ds}{refer to fig 3; \js|SWAPI.label|}
...
(even to \http{bank.ch}) if the context label is
...
%
\todo{ds}{refer to fig 3; \js|SWAPI.privileges|}
