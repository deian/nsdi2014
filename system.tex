...
In our case, we do not support the extension privileged APIs
(not just yet)
which makes it impossible to re-implement all extensions as
web applications.
%
However, extensions that rely only on content scripts can be easily
ported to Browbound.
%
