...
context label, hence \sys{} fetches the script.

Before executing the fetched script in a new browsing context, as
shown in Figure~\toref{fig:strength-1}, \sys{} ensures that the label
of the worker is at least as restricting as the current label.
%
Just as the context label protects all data in scope, the label of a
worker protects the data within the worker.
%
