...
%
As noted in Section~\ref{sec:system:worker},
the \js|LWorker| constructor takes an optional \js|Privilege| argument.
%
This allows a browsing context to grant child workers privileges they
own (e.g., the page-origin privilege or fresh privileges).
%
