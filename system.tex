...
\sys{} makes SOP's notion of authority of code over page content
...
page origin.
%
In turn, the privilege can are used when performing the \js|subsumes|
...
which can be used, for example, to downgrade label
\js|Label("https://bank.ch").and("https://amazon.com")| to
\js|Label("https://bank.ch")|.
%
In doing so, it is removing the restriction of imposed by
\https{amazon.com} in the label and declassifying data labeled as
such.
%
This, in turn, allows \https{bank.ch} to further declassify the data
(to the public label \js|Label()|) and disseminate it as necessary.
