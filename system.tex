...
%
Below, we extend our notion of first-class confinement to
pages/iframes by describing the design of a mostly untrusted password
manager---an application that allows users to use a single master
password to manage multiple site-specific passwords.
